        ...
        <ul class="am-list admin-sidebar-list">
            ...
            <li class="admin-parent">
                <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span>
                    业务模块 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                    <li><a href="<?php echo _url_ ?>admin/admin_add_form.php" class="am-cf"><span class="am-icon-check"></span> 添加借款人信息<span
                                class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
                    <li><a href="<?php echo _url_ ?>admin/admin_edit_form.php"><span class="am-icon-puzzle-piece"></span> 修改借款人信息</a></li>
